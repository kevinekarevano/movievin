...
const Search = ({ change, inputRef }) => {
  return (
    <div className="flex w-full justify-center mt-20 items-center space-x-2 ">
      <div className="shadow-[-1px_3px_55px_0px_#844BD2]  rounded-xl bg-gradient-to-r from-[#F78FF8] via-[#A5A586] to-[#844BD2] p-1">
